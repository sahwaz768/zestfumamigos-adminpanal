    ...
    <div className="admin-topbox">
      ...
      <div>
        <div className="slot-request">
          <div
            className="general-request"
            onClick={showgenerakbooking}
            id="general-request"
          >
            <h4>Slote Request</h4>
          </div>
        ...
        <div
          className="general-request-description"
          id="general-request-description"
        >
          <div className="xyz">
            <div className="user-profile">
              ...
              <div>
                ...
                <p>
                  User location: <span>BKC Mumbai</span>
                </p>
              </div>
            </div>
        ...
        <div
          className="extention-request-description"
          id="extention-request-description"
        >
          <div className="xyz">
            <div className="user-profile">
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRaynudV8sm-8G1JGqlusPXrWYMREc61jkYFQ&s" />
